...
$.fn.floatingWhatsApp=function(options){
	var settings=$.extend({
	phone:'',message:'',position:'left',popupMessage:'',showPopup:!1,autoOpen:!1,autoOpenTimer:4000,headerColor:'#128C7E',headerTitle:'',
},options);
...
if(settings.showPopup){
	...
	$(textarea).attr('id', 'textarealabelid');
	$(textarea).attr('aria-label', 'textarealabelid');
	var label=$(document.createElement('label'));
	$(label).attr('for', 'textarealabelid');
